  ...
  return (
    <div>
      ...
      <div className='p-10'>
        ...
        <h2 className="text-2xl mb-1">Step 1: Sign Up for an Unsplash Developer Account</h2><br></br>
        ...
        <h2 className="text-2xl mb-1">Step 2: Register Your Application</h2><br></br>
        ...
        <h2 className="text-2xl mb-1">Step 3: Understand the Endpoint</h2><br></br>
        ...
        <h2 className="text-2xl mb-1">Step 4: Make the API Request</h2><br></br>
        ...
        <img src='./unsplash4.png'class="w-96 h-auto"/><br></br>
        ...
        <h2 className="text-2xl mb-1">Step 5: Example Requests</h2><br></br>
